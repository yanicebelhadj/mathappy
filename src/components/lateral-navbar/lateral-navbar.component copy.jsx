    ...
    <div className="LateralNavbar">
      ...
      {/* <ul>
        ...
        <li
          onClick={() => {
            sixiemeActive();
            onFilterCategories("sixieme");
          }}
          className={`${SixiemeActive ? "active" : "null"}`}
        >
          <Sixieme />
        </li>
        <li
          onClick={() => {
            cinquiemeActive();
            onFilterCategories("cinquieme");
          }}
          className={`${CinquiemeActive ? "active" : "null"}`}
        >
          <Cinquieme />
        </li>
        <li
          onClick={() => {
            quatriemeActive();
            onFilterCategories("quatrieme");
          }}
          className={`${QuatriemeActive ? "active" : "null"}`}
        >
          <Quatrieme />
        </li>
        <li
          onClick={() => {
            troisiemeActive();
            onFilterCategories("troisieme");
          }}
          className={`${TroisiemeActive ? "active" : "null"}`}
        >
          <Troisieme />
        </li>
      </ul> */}
